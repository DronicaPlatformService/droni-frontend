...
extension $FunctionP4Extension<R, P1, P2, P3, P4> on R Function(
    P1, P2, P3, P4) {
  R invoke(P1 p1, P2 p2, P3 p3, P4 p4) => this(p1, p2, p3, p4);
}

extension $FunctionP5Extension<R, P1, P2, P3, P4, P5> on R Function(
    P1, P2, P3, P4, P5) {
  R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) => this(p1, p2, p3, p4, p5);
}

extension $FunctionP6Extension<R, P1, P2, P3, P4, P5, P6> on R Function(
    P1, P2, P3, P4, P5, P6) {
...
extension $FunctionP9Extension<R, P1, P2, P3, P4, P5, P6, P7, P8, P9> on R
